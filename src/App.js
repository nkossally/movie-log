  ...
  const reviews = [
    ...
    <Review
      ...
      paragraphs={[
        ...
        "Side note 1: I like to think about how films bend time and space. This film, like the show 24, which was airing at the time, occurs in real time. One minute in real time is one minute in the movie. This film also has many other relationships to time. Due to the history of the screenplay, it grafts Cold War era paranoia onto early 2000s techno-paranoia. Finally, the film is a time capsule. That last phone booth was removed from New York City in 2022, twenty years after the release of the film.",
