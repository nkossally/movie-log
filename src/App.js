...
function App() {
  ...
  const reviews = [
    ...
    releaseDate="1986"
    paragraphs={[
      `It’s hard to watch Woody Allen movies these days without thinking about the pedophilia allegations and Allen’s marriage to the adopted daughter of his former partner. It’s hard not to look for signs of his disorder in his films, and there are plenty of signs in ${TITLE_START} Hannah… ${TITLE_END} of Allen’s morbid narcissism, which goes hand-in-hand with pedophilia, I think. This does not diminish the movie, which is pretty damn good. The title of the movie suggests it’s about Hannah, played by Mia Farrow, and her two sisters, played by Barbara Hershey and Dianne Wiest. But it’s also about the men in their lives: Woody Allen, Michael Caine, and Max von Sydow. In fact, after the opening ensemble scene, Woody Allen gives Woody Allen the first extended segment that is just about one character. Hannah/Mia Farrow, is the least important and least interesting character among the three sisters. She is the perfect, successful sister. Dianne Wiest is the struggling, temperamental artist. And Barbara Hershey is the impulsive beauty who just blows with the wind, having affairs with older professors, taking random classes at Columbia University because of no direction in life, driven only by libido and vague intellectual interests. The sisters are interesting. Dianne Wiest’s jealousy and dependence on Mia Farrow feels real. The aspect of the film that feels less justified is the near incestuous relationships. Woody Allen is Farrow’s ex-husband. After they split, Farrow encourages Allen to date Dianne Wiest. In addition, Barbara Hershey has a secret affair with Mia Farrow’s husband. This is all weird bohemian behavior, but the film presents the affairs as if they’re just what adults do. Most women would not set up their exes with their sisters, I imagine. But I think Allen has incestuous interests, and he normalizes inappropriate relationships by grafting his inappropriate feelings onto the women in the movie. This is a common trick of Allen. He puts his dark hedonism and mean-spiritedness into women characters. That’s why his female characters are very interesting. Much more interesting than the males. As for Allen’s character, he is practically in a different movie. His scenes are all comedic, while most other scenes are dramatic. Allen plays a hypochondriac who thinks he is dying, learns that he is not, and then tries out several religious in search of the meaning of life, while still running from death. Just as in reality, Allen’s character is a narcissist. His fear of death stems from self-absorption. His character explicitly states in voice-over that it is impossible that he can live in a city as great as New York and yet face death. I think the character and the person, Woody Allen, have some sort of megalomania that makes death hard to fathom. His megalomania is bizarrely tethered to his identity as a New Yorker.`,
      `${TITLE_START} Hannah and Her Sisters ${TITLE_END} probably shouldn’t work as a movie, but it does because of Allen’s ingenious insertions of his light comedic scenes between the dramatic ones. Without his scenes, ${TITLE_START} Hannah… ${TITLE_END} would be a tepid melodrama. With Allen’s scenes, it becomes great. Allen’s character is obsessed with death, while the women are alive. Hannah/Farrow works to keep her family together. Hershey chases after life, which equates to chasing after men impulsively. Wiest desperately chases after the glory of a successful artist. Most of the characters are neurotic, and Allen’s brilliant use of voice over conveys their neuroticism. Neuroticism can chase life and it can chase death. The women chase life while Allen chases death. Eventually, Allen’s character falls in love with Wiest, and he is alive again. Allen found a woman to revive him. He found a woman to suck the life out of. Aside from starting a new relationship with Wiest, Allen’s character recovers from fear of death by going to the movies and realizing that he should chase joy instead of death. Once again, Allen reveals his self-importance. Of course, the movies are a reason to live because Allen, in reality, made so many of them.`,
      ...
      `Side note: In Allen’s first scene, a television producer informs him that a sketch on child molestation is inappropriate. Another producer suggests that they go with a gay joke instead, because, apparently, homosexuality is one step below pedophilia in indecency. Allen keeps telling on himself.`,
