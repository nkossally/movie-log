  ...
  return (
    <div>
      ...
      <Review 
        ...
        date="12/13/2024"
        releaseDate="1996"
        text="Deeply unserious film about an amnesiac (Geena Davis) who does not recall anything that happened to her more than eight years ago. The plot happens and Davis recovers her lost identity and uncovers a deep state conspiracy. I’d have to watch this movie many times to understand how stupid it is. Some story elements are secret agents, guns, water torture, casual sexual harassment, terrible wigs, many jokes about anal rape in prison, horrid 90s saxophone synth, and Geena Davis racing a car on ice skates and winning despite being visibly slower and on ice skates. Academy award winner Geena Davis gives a committed performance and Samuel L. Jackson gives a Samuel L. Jackson performance. This film has a libido and shows Geena Davis in wifebeaters, in underwear underwater and in the shower. Even Samuel L. Jackson has a nude scene somebody asked for. I’m not complaining. During the moment that the villain explains that the whole plot hinges on the C.I.A. plotting terrorist attacks in order to force Congress to increase the security budget, I was afraid this 90s paranoia about the security state stood some danger of making this movie smarter. Don’t worry. It doesn’t. This movie couldn’t be stupider. Perfect 90s crap." 
        text2=""
        text3=""
        theater=""
        rating={10}
