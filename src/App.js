  ...
  return (
    <div>
      ...
      {showLinks && (
        ...
        <button className="title-link" onClick={scrollRefIntoView(ref115)}>
        ...
        <button className="title-link" onClick={scrollRefIntoView(ref113)}>
         ...
         <button className="title-link" onClick={scrollRefIntoView(ref112)}>
          ...
          <button className="title-link" onClick={scrollRefIntoView(ref107)}>
            North by Northwest
          </button>
          <button className="title-link" onClick={scrollRefIntoView(ref106)}>
            The Cable Guy
          </button>
          <button className="title-link" onClick={scrollRefIntoView(ref105)}>
            Velvet Goldmine
          </button>
      ...
      <Review 
        ...
        text3="The movie only falters when trying to flesh out the family members of Baptiste. I respect Leigh’s communal instinct and resistance of main-characterism. But I did not get much out of most scenes that did not include Baptiste, hair salon scene excluded. For example, I think Leigh uses one scene to show how one of Baptiste’s nieces experiences racialized bullying at work, but there isn’t enough about the character of the niece to make the scene work."
        theater=""
        rating={9}
      /> 
      <Review 
      ...
      <Review 
        ...
        text3="Side-note: This movie has some Cruisian race play. [Spoiler] Cruise’s boss, Billy Crudup, turns out to be a maniac who intentionally armed terrorists and framed he and Cruise’s boss, Laurence Fishbourne, as the rogue agent. When Crudup explains his master plan to Cruise, he calls Fishbourne a “diversity hire.” I am not sure why this line is in the film. It can be interpreted various ways. Crudup is a bad guy, so his resentment of black people isn’t validated by the film, necessarily. Later on, after the plot resolves, Fishbourne apologizes to Cruise for being a hard-ass and Fishbourne literally says that he owes Cruise “reparations.” It is very bad word choice for a black character to tell Cruise that he owes Cruise reparations. This is a slip up, but a telling one. The Mission Impossible series is mostly apolitical and therefore has no space or time to comment on anything as fraught as race. The series is about the power of the individual over and above institutions. Sure, Cruise works for an institution called the IMF, but he is above it. Sure, Cruise is a white man with American citizenship who flies into other countries to carry out espionage on behalf of the United States, but it’s not about empire building. It’s about saving the world from bad guys. Mission Impossible is uninterested in institutional thinking, so it is jarring when Billy Crudup’s comment stirs thoughts about institutional racism. That line, like the reparations line, was a mistake. It’s easier to accept that Thandie Newton was put in the fuck box and Monaghan was put in the marriage box if race is presumed and not stated out loud."
