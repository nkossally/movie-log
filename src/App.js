  ...
  return (
    <div>
      ...
      <Review 
        ...
        text3="“Come as You Are” by Nirvana plays as camera zooms in on Drew Starkey the first time Craig sees hm. Reminiscent of much parodied scene of Can’t Hardly Wait when everyone at party stops to notice that Jennifer Love Hewitt entered the room. Anologous scene here is equally absurd Caucasian nonsense. I have suspected that there may be no underlying philosophy or meaning to Guadagnino’s flair for visual art, just libido. This film all but confirms that. "
        theater="Alamo Drafthous, 28 Liberty Street, New York, New York"
        rating={4}
      /> 
      <Review 
        title="Juror #2" 
