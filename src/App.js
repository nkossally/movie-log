    ...
    <div>
      ...
      {showLinks && (
        <div className="links-container">
          <button onClick={scrollRefIntoView(ref1)}>Reacher</button>
          <button onClick={scrollRefIntoView(ref2)}>Logan Luck</button>
          <button onClick={scrollRefIntoView(ref3)}>Femme</button>
          <button onClick={scrollRefIntoView(ref4)}>I Care a Lot</button>
          <button onClick={scrollRefIntoView(ref5)}>
            Mission Impossible Dead Reckoning
          </button>
          <button onClick={scrollRefIntoView(ref6)}>Fabulous Baker Boys</button>
          <button onClick={scrollRefIntoView(ref7)}>Death Becomes Her</button>
          <button onClick={scrollRefIntoView(ref8)}>The Challengers</button>
          <button onClick={scrollRefIntoView(ref9)}>Devil Wears Prada</button>
          <button onClick={scrollRefIntoView(ref10)}>eXistenZ</button>
        </div>
      )}
