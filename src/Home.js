...
const ITALIC_START = "[ITALIC-START]"
const ITALIC_END = "[ITALIC-END]"
const SPOILER_START = "[SPOILER-START]"
const SPOILER_END = "[SPOILER-END]"
...
function Home() {
  ...
  const reviews = [
    ...
    <Review
      ...
      releaseDate="1991"
      paragraphs={[
        `The subtext of the film is as interesting as the text. A released felon (Robert De Niro) terrorizes the family of the public defender (Nick Nolte) who buried evidence that may have exonerated the felon of rape. De Niro personifies evil, perhaps, but he is the shadow of the upper middle-class Nolte. De Niro has sexual interest in Nolte's teenage daughter, a reflection of Nolte's obsession with his daughter's innocence and Nolte's violence towards his daughter. De Niro may be the devil, but Nolte is no angel. Nolte uses the law to get De Niro in prison (where De Niro experienced rape), Nolte pays money to have thugs beat De Niro up, and Nolte uses his connections to get cops to harass De Niro with full strip searches (the camera suggesting Nolte's homoerotic interest). Nolte also contemplates committing infidelity. The subtext is that stranger danger belies the danger that fathers and husbands pose to their own families. This film also fits within the suburban rot genre of films (like ${ITALIC_START} Blue Velvet, The Ice Storm, American Beauty, The Ref, ${ITALIC_END} etc.).`,
      ]}
      theater=""
      rating={9}
    />,
    ...
    <Review
      ...
      releaseDate="2025"
      paragraphs={[
        `Critics generally despised ${ITALIC_START} Captain America: Brave New World ${ITALIC_END} when it was released this February, giving it a 48% rating on Rotten Tomatoes. The rating is a little low because this installment of the ${ITALIC_START} Captain America ${ITALIC_END} franchise is not all that different from 2014’s ${ITALIC_START} Captain America: The Winter Soldier, ${ITALIC_END} which boasts a 90% rating. The execution of ${ITALIC_START} Winter Soldier ${ITALIC_END} is much better, but the stories are similar. ${SPOILER_START} ${ITALIC_START} Brave New World ${ITALIC_END} is a political thriller about a mutant genius who uses mind control of political leaders to provoke global destabilization. ${ITALIC_START} Winter Soldier ${ITALIC_END} is a political thriller about a fascist organization that infiltrates a government organization in order to provoke global destabilization.  ${SPOILER_END} The plotting and pacing of ${ITALIC_START} Brave New World ${ITALIC_END} are much worse than those in ${ITALIC_START} Winter Soldier, ${ITALIC_END} but the DNA is the same.`,
        `Some critics argue that ${ITALIC_START} Brave New World ${ITALIC_END} is not political enough, presumably because the film does not spend enough time bashing the Harrison Ford character, who is a stand-in for a Republican president. ${ITALIC_START} Brave New World ${ITALIC_END} is careful about not being too partisan because Marvel movies are supposed to appeal to everyone. Similarly, ${ITALIC_START} Winter Soldier ${ITALIC_END} is not partisan. ${ITALIC_START} Winter Soldier ${ITALIC_END} merely took a stance against Nazis, the most obvious and cowardly “political” stance to take. Paranoid thrillers like the ${ITALIC_START} Captain America ${ITALIC_END} movies (or like Hitchcock films or the Grisham adaptations of the 90s) are not and have never been political motivators. If paranoid thrillers do anything more than entertain, they instill fear and paralysis. Paranoid thrillers suggest that evil individuals corrupt powerful institutions, and, if the ending is happy, exceptionally good individuals expose corruption at the highest levels. In the ${ITALIC_START} Captain America ${ITALIC_END} movies, the good guys beat the Nazis and evil mutants, and restore governmental institutions such that they secure American lives without impinging too much on American freedoms. Whether they end happily or not, paranoid thrillers do not encourage collective action. Just stasis and/or fear. ${ITALIC_START} Brave New World ${ITALIC_END} is a boring, muddled, political thriller. It does not have much substance. Neither did ${ITALIC_START} Winter Soldier. ${ITALIC_END} Neither do MCU movies in general. Perhaps weariness over the sameness of these movies explains the poor critical reception.`,
      ]}
      theater=""
      rating={3}
    />,
    <Review
      ...
      releaseDate="2024"
      paragraphs={[
        `${ITALIC_START} It Ends with Us ${ITALIC_END} grossed $351 million at the box office, the 20th highest grossing movie of 2024. It is the only “women’s issues” film in the top twenty (besides, perhaps, ${ITALIC_START} Wicked), ${ITALIC_END} and it is one of only five non-sequels on the list. Money is the best way to talk about the film because it has more to say about money than it has to say about domestic abuse, the ostensible topic of the film. In ${ITALIC_START} It Ends, ${ITALIC_END} Blake Lively dates and marries Justin Baldoni, an abusive man. ${SPOILER_START} After several highly edited and glossed over scenes of physical and sexual violence, Lively leaves Baldoni and restarts her relationship with her high school ex. ${SPOILER_END} The characters have very few characteristics, but we do know how they make money. Baldoni is a surgeon and Lively is also wealthy. She owns a flower shop, which is more typical of a woman in a Rom-Com than a serious social drama. Lively is also the daughter of a mayor, so she is well-connected. She is financially independent, something many victims of domestic abuse are not. She suffers abuse, but she, unlike many, has an escape route: money. We can see money in her consistently chic outfits. She wears the simple but elegant clothing rich people wear. She always has to look great, which is why the movie never shows the brutality of domestic abuse. It shows Lively putting on make-up afterwards, looking fantastic as usual, even with a slight bruise that only accentuates the beauty of her almond-shaped blue eyes. ${SPOILER_START} When Lively divorces Baldoni, she loses the status of a surgeon’s wife, but, presumably, she gets alimony and child support. In addition, the beautiful man she takes up with after leaving Baldoni owns a company of his own – a popular restaurant in Boston. ${SPOILER_END} Lively is never unglamorous in this movie about domestic abuse. She always has money.`,
        `${ITALIC_START} It Ends with Us ${ITALIC_END} is an uninteresting movie that contributes nothing to the genre of domestic abuse films. Lively’s lawsuit against Justin Baldoni, and his countersuit, are far more interesting than the movie whose production caused the lawsuits. In 2024, Lively sued Baldoni for inappropriate sexualized behavior on set, and for using a PR firm to smear her reputation. In 2025, Baldoni countersued Lively for defamation, and claimed the Lively tried to take over production of ${ITALIC_START} It Ends. ${ITALIC_END} Most of the internet seems to have taken Baldoni’s side a year before trial starts. For the sake of social justice, it would be best if court ruled on Lively’s claims of workplace harassment before the court of public opinion litigated Lively’s personality. But the court of public opinion moves faster than the state, and most of the Internet has ruled that Blake Lively is a bitch and Justin Baldoni is a nice, soy-boy feminist, despite his playing the post-Me-Too antifeminist card of combating harassment claims with defamation claims. He is a great guy, despite using the very same PR firm that Johnny Depp used to destroy the reputation of Amber Heard and destroy the Hollywood division of the Me-Too movement. Lively and Baldoni are two combatants in the Hollywood system, so the harassment claims matter less than money. One or none of them will survive the extralegal battle to destroy the ability of the other to continue to earn Hollywood film star paychecks. The legal case is all about money, just like the movie itself, and just like movies in general. Domestic abuse cannot be reduced to money alone, but in Hollywood it can.`,
      ]}
      theater=""
      rating={3}
    />,
    ...
    <Review
      ...
      releaseDate="1986"
      paragraphs={[
        `It’s hard to watch Woody Allen movies these days without thinking about the pedophilia allegations and Allen’s marriage to the adopted daughter of his former partner. It’s hard not to look for signs of his disorder in his films, and there are plenty of signs in ${ITALIC_START} Hannah… ${ITALIC_END} of Allen’s morbid narcissism, which goes hand-in-hand with pedophilia, I think. This does not diminish the movie, which is pretty damn good. The title of the movie suggests it’s about Hannah, played by Mia Farrow, and her two sisters, played by Barbara Hershey and Dianne Wiest. But it’s also about the men in their lives: Woody Allen, Michael Caine, and Max von Sydow. In fact, after the opening ensemble scene, Woody Allen gives Woody Allen the first extended segment that is just about a single character, Woody Allen. Allen plays a hypochondriac who is very similar to Woody Allen. As for the women, Hannah/Mia Farrow, is the least important and least interesting character among the three sisters. She is the perfect, successful sister. Dianne Wiest is the struggling, temperamental artist. And Barbara Hershey is the impulsive beauty who just blows with the wind, having affairs with older professors, taking random classes at Columbia University because she has no direction in life, driven only by libido and vague intellectual interests. The sisters are well written and have believable sisterly dynamics. The less believable aspects of the sister characters derive from Allen’s perversity. For example, Woody Allen is Farrow’s ex-husband. After they split, Farrow encourages Allen to date Dianne Wiest. I don’t know anyone who would set their sister up with their ex-husband. In addition, Barbara Hershey has a secret affair with Mia Farrow’s husband. This is all weird bohemian behavior, but the film presents the affairs as if they’re just what adults do. The sisters have near incestuous relationships despite appearing to be normal, well-adjusted, upper-middle-class people (except Wiest, who is half crazy). The lack of boundaries of the women is odd, but Woody Allen presents them as normal. I think Allen has incestuous interests, and he normalizes inappropriate relationships by grafting his inappropriate feelings onto the women in the movie. This is a common trick of Allen’s. He puts his dark hedonism and mean-spiritedness into women characters. That’s why his female characters are very interesting. Much more interesting than the males. `,
        `Allen wrote a lot of great Oscar winning parts for women, but his films are not always kind to women. In ${ITALIC_START} Hannah…, ${ITALIC_END} Hannah/Farrow is mean to her mother, an old woman who cannot accept that she is no longer attractive to young men. I do not think Hannah, who is kind and empathic, would be so dismissive of this common experience of aging beauties. But I think Allen would. In addition, at one point, Dianne Wiest’s character remarks on how she is not sixteen anymore. I do not know any woman over thirty who thinks sixteen was their best year. But I think Allen thinks sixteen is the peak age of a girl/woman. The characters in ${ITALIC_START} Hannah and Her Sisters ${ITALIC_END} are well-written, but Allen assigns them a bit too much misogyny that exists in him, not the characters.`,
    ...
    <Review
      ...
      paragraphs={[
        ...
        `Side note 2: Every character in ${ITALIC_START} The Royal Tenenbaums ${ITALIC_END} is a writer. In addition, the movie is narrated as if it is a book. This is one of the charming aspects of the movie. Cuteness works on me, sometimes.`,
      ]}
      theater=""
      rating={10}
    />,
    ...
    <Review
      ...
      date="11/22/2024"
      releaseDate="1997"
      text="Fascinating and peculiar high concept action film with sci fi elements. FBI agent John Travolta goes undercover by surgically stealing the face of comatose terrorist Nicolas Cage, only to get the tables turned when Cage wakes up and steals Travolta’s face. The film prepares you for how unserious it is with its opening scene. Cage huddles in some bushes somewhere, aiming his gun at Travolta, who is riding a carousel with his small son at a carnival. At first, it seems that Cage lowers his gun because of the presence of the small boy. Turns out that Cage paused to take a sip of soda before firing, injuring Travolta and killing the boy. As in many Hollywood films, trauma is just plot. This highly stylized scene on the carousel is played for laughs. After an injured Travolta and his son fall off the plastic carousel horse in slow motion, the camera rests on the horse for a second, and it neighs. Does every hardened movie cop need a loved one to die within the first five minutes of a movie in order to establish character motivation? Maybe. Can an inanimate blood-spattered carousel horse say neigh? TBD."
    ...
    <Review
      ...
      date="12/07/24"
      releaseDate="2024"
      text="Straightforward mostly linear high concept legal thriller about juror who guilty of crime he assigned to reach verdict on. Feels like a 90s film so breath of fresh air. Efficient. No bloat. Clint Eastwood’s bare bones directing has less flair than an episode of [ITALIC-START] Succession. [ITALIC-END] Perfectly good movie seemingly from past when movies were movies."
      text2=""
      rating={7}
    />,
    <Review
  ...
  const titleQuery = searchParams.get('title')?.toLocaleLowerCase()
