...
export const ITALIC_END = "[TITLE-END]"
...
export const REVIEWS = [
  ...
  <Review
    ...
    date="12/07/24"
    releaseDate="2024"
    text="Straightforward mostly linear high concept legal thriller about juror who guilty of crime he assigned to reach verdict on. Feels like a 90s film so breath of fresh air. Efficient. No bloat. Clint Eastwood’s bare bones directing has less flair than an episode of [ITALIC-START] Succession. [TITLE-END] Perfectly good movie seemingly from past when movies were movies."
    text2=""
    rating={7}
  />,
  <Review
