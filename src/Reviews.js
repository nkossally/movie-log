...
export const REVIEWS = [
  ...
  <Review    title="Constantine"
    ...
    rating={7}
  />,
  <Revietitle="Dewey Cox" text="Yes" rating={8} />,
  ...
  <Review    title="Civil War"
    ...
    rating={9}
  />,
  <Revietitle="Speed " text="Dumb" rating={5} />,
  ...
  <Review    title="Phantom Thread"
    ...
    rating={8}
  />,
  <Revietitle="Triple Frontier" text="Meh." rating={5} />,
  <Review    title="Barfly"
